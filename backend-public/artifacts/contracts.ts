...
export namespace BtcDaysContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "btc-days";
    ...
    export namespace Functions {
        ...
        // get-number-of-days
        export namespace GetNumberOfDays {
            export const name = "get-number-of-days";
...
export namespace BtcDaysMintContract {
    export const address = "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM";
    export const name = "btc-days-mint";
